package com.hecto.vaccount.dto;
...
@NoArgsConstructor
@AllArgsConstructor
public class VaccountModifyDto {
    ...
    public VaccountModifyDto(VaccountModifyHistory savevaccountModifyHistory) {
        BeanUtils.copyProperties(savevaccountModifyHistory,this);
    }
}
